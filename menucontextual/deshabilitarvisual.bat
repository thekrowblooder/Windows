...
color 8F
echo ===================================================
echo     Deshabilitando Efectos Visuales de Windows
echo ===================================================
...
echo Deshabilitando efectos visuales...
echo ---------------------------------------------------

:: Deshabilitar los efectos visuales
...
reg add "HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\VisualEffects" /v "VisualFX" /t REG_DWORD /d 0 /f >nul 2>&1

:: Deshabilitar efectos de transparencia y Aero
reg add "HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\VisualEffects" /v "AeroGlass" /t REG_DWORD /d 0 /f >nul 2>&1

echo ---------------------------------------------------
echo Los efectos visuales han sido deshabilitados.
echo ===================================================
